...
namespace ProyectoUdemy.Controllers
{
    ...
    public class PeliculaController:ControllerBase
    {
        ...
        public PeliculaController(ApplicationBbContext context,
        ...
        [HttpGet]
        public async Task<ActionResult<List<PeliculaDTO>>> Get(string parameter)
        {
        ...
        public async Task<ActionResult> put(int id,[FromForm]PeliculaCreacionDTO peliculaCreacionDTO)
        {
           ...
           if (peliculaCreacionDTO.Poster !=null)
           {
                using (var memoryStream = new MemoryStream())
                {
                  ...
                  var  contenido = memoryStream.ToArray();
                   var extension=Path.GetExtension(peliculaCreacionDTO.Poster.FileName);
                   peliculaDB.Poster=await almacenadorArchivos.EditArchivo(contenido,
                                                                      extension,
                                                                      contenedor,
                                                                      peliculaDB.Poster,
                                                                      peliculaCreacionDTO.Poster.ContentType);
